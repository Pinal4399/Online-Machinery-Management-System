...
Partial Class addemployee
    ...
    Protected Sub btnadd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnadd.Click
        Try
            cmd = New SqlCommand("insert into tbl_employee values(@enm,@etype,@eid,@add,@city,@qua,@exp,@pno,@jt,@bd,@sal,@pwd)", con)
            ...
            cmd.Parameters.Add(New SqlParameter("@etype", Convert.ToString("3")))
            ...
            cmd.Parameters.Add(New SqlParameter("@sal", Convert.ToDecimal(txtsal.Text)))
            ...
            'cmd.Parameters.Add(New SqlParameter("@sq", DropDownList1.SelectedItem.Text))
            ...
            If cnt = 1 Then
                MsgBox("New Branch Manager is Successfully added and  Password has been mailed to Branch manager email id.", MsgBoxStyle.OkOnly, " Add Branch Manager ")
            End If
            con.Close()
    ...
    Protected Sub txtexp_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtexp.TextChanged
